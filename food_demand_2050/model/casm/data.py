...
# ---- time sets (CASM.gms 0.1) — paper version CASM v2.2.7 ---------------
# (base year 2024, projections 2025-2050, as in 食物预测2050/CASM20251118*)
TPHIS, TPREV, TBASE = "2022", "2023", "2024"
TPJ1, TFINAL = 2025, 2050
...
TSP = ["2023", "2024", "2035", "2050"]  # selected reporting periods (CASM.gms)
...
class Data:
    ...
    def __init__(self, casm_dir):
        ...
        # paper version (v2.2.7) zeroes values <= 1.1 (v2.2.8 uses 0.1)
        tb = TBASE
