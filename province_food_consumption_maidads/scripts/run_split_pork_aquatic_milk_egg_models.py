...
OUT = RESULTS / "SplitPorkAquaticMilkEgg"
...
def write_summary(outputs: list[dict], started_at: str) -> None:
    ...
    (OUT / "SPLIT_PORK_AQUATIC_MILK_EGG_RESULTS.md").write_text("\n".join(lines), encoding="utf-8")
...
def main() -> None:
    ...
    print(OUT / "SPLIT_PORK_AQUATIC_MILK_EGG_RESULTS.md")
