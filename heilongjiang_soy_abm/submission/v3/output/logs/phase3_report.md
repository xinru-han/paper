...
m7_lead_placebo            dpi100_base  0.1583 0.4430 0.7209 136
m7_lead_placebo       dpi100_base_lead -0.1522 0.4688 0.7454 136
m7_lead_placebo          plant_soy_lag  0.1583 0.1334 0.2353 136
m7_lead_placebo              peer_lag0  0.7426 0.3126 0.0175 136
   m7_lead_only       dpi100_base_lead  0.0138 0.0189 0.4656 136
   m7_lead_only          plant_soy_lag  0.1554 0.1365 0.2548 136
   m7_lead_only              peer_lag0  0.7529 0.3220 0.0194 136
          r_lov        dpi100_base_lov  0.1921 0.1728 0.2662 300
          r_lov          plant_soy_lag  1.6675 0.5925 0.0049 300
          r_lov              peer_lag0  2.8790 2.2145 0.1936 300
...
Firth β=0.229
前导安慰剂(Δπ_t+1): {'n': 136, 'b_contemp': 0.15826034319157772, 'p_contemp': 0.7208804610634438, 'b_lead': -0.1521922171277669, 'p_lead': 0.7454328267827953, 'b_lead_only': 0.013814729899507508, 'p_lead_only': 0.46556717617416754, 'wild_p_lead': 0.8091618323664733}
LOV(剔本村价格/成本): {'n': 300, 'b_lov': 0.19210952047439409, 'p_lov': 0.2662349755985278, 'ame_lov': 0.02229588265633278, 'ame_lov_ci': [-0.01994079428921391, 0.06453255960187947]}
