...
"$STATA" -q -b do "$PROJECT/code/05_estimate_extended_models.do" "$PROJECT"
"$STATA" -q -b do "$PROJECT/code/06_extended_elasticities.do" "$PROJECT"
python3 "$PROJECT/code/07_build_extended_report.py" "$PROJECT"
