...
foreach spec in aids quaids easi1 easi3 {
    estimates use `"`project'/output/estimate_nlsur_cf_`spec'.ster"'
    capture drop estimation_sample
    gen byte estimation_sample = 1
    attach_estimation_sample
    global REFOUT `"`project'/output/reference_nlsur_cf_`spec'.csv"'
