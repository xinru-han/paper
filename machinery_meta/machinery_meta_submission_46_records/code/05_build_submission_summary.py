...
def main():
    ...
    subgroup_display = subgroup[["Target", "Path", "k", "PCC", "p", "significance",
                                  "interpretation_note"]].fillna("")
    lines = [
        ...
        "",
        subgroup_display.to_markdown(index=False),
        "",
        "Efficiency-AML contains one record. Area contains no MCI record; its WLS "
        "path comparison therefore uses AMS as the estimable baseline and should be "
