...
def write_summary(df, meta, wls, fat):
    ...
    lines = [
        "# Revised 46-record strict-path meta-analysis",
        "",
        "The analysis uses 46 direct MCI/AMS/AML records, including six full "
        "coding rows restored after review. OTH records are not analysed.",
        "",
        "## Sample counts",
        "",
        counts.to_markdown(),
