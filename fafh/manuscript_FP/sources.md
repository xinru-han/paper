...
## H. Retail-weight-factor sensitivity (added 2026-07-07)
- Gap-weighted meat (pork+beef+poultry) closure share recomputed with all retail_conv factors scaled by +/-10%: 54.1% (+10%) to 106.3% (-10%), baseline 71.7%. Stored in numbers.json key `retail_factor_sensitivity`; quoted in the Section 7 caveats paragraph as "roughly 54 and 106 percent".
