...
\textbf{Use total consumption in demand and food security assessments.} Government and international agencies that project grain and food demand or assess self-sufficiency should use total (at-home plus away-from-home) consumption, not at-home consumption alone. Our coefficients provide a consistent way to scale from at-home to total consumption by category and province-year. Incorporating these coefficients into existing food balance or demand models will improve the accuracy of demand-side estimates.
