...
- **DP1（价格来源，按发改委审计结论定稿 2026-07-07）**：无 NBS 分类指数提取件；发改委监测数据审计发现——种子价格完全缺失、柴油仅 2006–2010，但"农村居民服务价格"月报有**机耕费/机收费（元/亩）**2006–2010、2013–2024（2011–12 断档），肥料/农膜/农药 2003–2025 连续高质量。据此：
  ...
  - mach = 发改委机耕费+机收费省级年均价（元/亩，正是机械服务的市场租金概念）；2011–12 断档按省对数线性插值；2004–05 用汇编机械作业费省级亩均值增长率外推，全部记录日志。
...
- 农村居民服务价格月报 → 机耕费/机收费（元/亩）2006–2010、2013–2024（2011–12 断档插值）→ w_mach。
