...
save_tab(list("Full sample (2013-2022)"=m_wage_full, "2013-2020 subsample (pre-break)"=m_wage_2013_2020),
         ...
         notes="Note: SE clustered by township. Outcome = asinh(real wage income), self-built from itemized survey questions (hg02_1..hg11_1, 2013-2020) or the four new aggregated wage items (2021-2022: local/migrant/village-cadre-teacher/other wage income), CPI-deflated, per the original 08_income_build.py (recovered from scripts/08_income_build.py) -- winsorized at 1%/99% before the asinh transform. Full-sample column reproduces the original M2 wage coefficient EXACTLY: -0.2646***, N=11,258. The questionnaire item set changes exactly at 2021, coinciding with the treatment period; the 2013-2020 subsample avoids this break entirely at the cost of dropping 2021-2022 variation, which also means 2020 is the ONLY post-treatment year identifying the coefficient in that column -- the much larger point estimate (-1.63 vs. -0.26) and wider SE should be read as reflecting this thinner identification (fewer post-treatment year x county cells), not necessarily a larger true effect. The two columns AGREE in sign and both remain significant at conventional levels.")
